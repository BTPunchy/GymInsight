...
export default function DanceRoom() {
  ...
  const fetchRoomData = () => {
    axios
      .get("http://localhost:1234/rooms/Dance")
  ...
  return (
    <div className="flex flex-col gap-4 p-6 md:flex-row md:items-start">
      ...
      <div className="md:w-1/2 space-y-4">
        <img src={DanceImg} alt="Dance Room" className="rounded-lg shadow-md" />
        <p className="text-white">
          A modern dance studio featuring smooth flooring, natural light, and an inspiring vibe for performers.
        </p>
      </div>
